...
full_data_1, node_features_1, edge_features_1, train_data_1, val_data_1, test_data_1 = \
  get_data_node_classification(DATA, use_validation=args.use_validation,p=0.1)

full_data_2, node_features_2, edge_features_2, train_data_2, val_data_2, test_data_2 = \
  get_data_node_classification(DATA, use_validation=args.use_validation,p=0.8)

max_idx = max(full_data_1.unique_nodes)

train_ngh_finder = get_neighbor_finder(train_data_1, uniform=UNIFORM, max_node_idx=max_idx)
...
for i in range(args.n_runs):
  ...
  decoder = MLP(node_features_1.shape[1], drop=DROP_OUT)
  ...
  for epoch in range(args.n_epoch):
    ...
    for k in range(num_batch):
      ...
      sources_batch_1 = train_data_1.sources[s_idx: e_idx]
      destinations_batch_1 = train_data_1.destinations[s_idx: e_idx]
      timestamps_batch_1 = train_data_1.timestamps[s_idx: e_idx]
      edge_idxs_batch_1 = full_data_1.edge_idxs[s_idx: e_idx]
      labels_batch_1 = train_data_1.labels[s_idx: e_idx]

      sources_batch_2 = train_data_2.sources[s_idx: e_idx]
      destinations_batch_2 = train_data_2.destinations[s_idx: e_idx]
      timestamps_batch_2 = train_data_2.timestamps[s_idx: e_idx]
      edge_idxs_batch_2 = full_data_2.edge_idxs[s_idx: e_idx]
      labels_batch_2 = train_data_2.labels[s_idx: e_idx]
      ...
      labels_batch_torch = torch.from_numpy(labels_batch_1).float().to(device)
    ...
    val_auc = eval_node_classification(tgn, decoder, val_data_1, full_data_1.edge_idxs,val_data_2,full_data_2.edge_idxs, BATCH_SIZE,
  ...
  if args.use_validation:
    ...
    test_auc = eval_node_classification(tgn, decoder, test_data_1, full_data_1.edge_idxs,test_data_2, full_data_2.edge_idxs, BATCH_SIZE,
                                        n_neighbors=NUM_NEIGHBORS)
  else:
